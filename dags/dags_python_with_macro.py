...
with (DAG(
    ...
    @task(task_id='task_using_macros',
          template_dict={'start_date': '{{ (data_interval_end.in_timezone("Asia/Seoul") + macros.dateutil.reltaivedelta.relativedelta(months=-1, day=1)) | ds }}',
    ...
    def get_datetime_calc(**kwargs):
        ...
        print(prev_month_day_last.strftime('%T-%m-%d'))
